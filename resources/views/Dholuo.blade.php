@extends('layouts.app', ['title'=>'Dholuo'])
@section('content')
<div class="m-2" style='min-height:500px;'>
    <form action="/createDholuo" method="post" class="row d-flex justify-content-center" enctype="multipart/form-data" novalidate class="needs-validation">
        @csrf
        <div class="col-8 p-2 m-6">
            <div class="form-floating mb-2">
                <input type="text" name="d_title" placeholder=' ' class="form-control" required>
                <label for="">Dholuo Title</label>
            </div>
            <div class="form-floating mb-2">
