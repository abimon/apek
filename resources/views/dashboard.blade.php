        ...
        @foreach($posts as $post)
            <div class="row alert alert-success">
                ...
                <div type='button' class='col-3'>
                    <a href='/unpublish/{{$post->id}}' style="text-decoration:none;" class='text-danger'>Unpublish</a>
                </div>
                @else
                <div type='button' class='col-3'>
                    <a href='/publish/{{$post->id}}' style="text-decoration:none;" class='text-info'>Publish</a>
                </div>
                @endif
