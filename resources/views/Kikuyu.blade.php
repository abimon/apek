@extends('layouts.app', ['title'=>'Kikuyu'])
@section('content')
<div class="m-2" style='min-height:500px;'>
    <form action="/createKikuyu" method="post" class="row d-flex justify-content-center" enctype="multipart/form-data" novalidate class="needs-validation">
        @csrf
        <div class="col-8 p-2 m-6">
            <div class="form-floating mb-2">
                <input type="text" name="y_title" placeholder=' ' class="form-control" required>
                <label for="">Kikuyu Title</label>
            </div>
            <div class="form-floating mb-2">
            ...
            <div class="form-floating mb-2">
                <input type="text" name="composer" placeholder=' ' class="form-control">
                <label for="">Composer</label>
            </div>
            <div class="form-floating mb-2">
                <input type="text" name="key" placeholder=' ' class="form-control">
                <label for="">Key</label>
            </div>
            <h3>Stanza 1</h3>
